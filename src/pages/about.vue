    ...
    <el-row class="main" type="flex" justify="center">
      <el-col :span="16">
        ...
        <div class="statement">
          ...
          <div class="item">座右铭：{{baseInfo.motto}}</div>
        </div>
        <div class="statement">
          <div class="item">Email：{{baseInfo.email}}</div>
          <div class="item">QQ：{{baseInfo.qq}}</div>
          <div class="item">
            CSDN：
            <a
              target="_blank"
        ...
        <el-card shadow="always">
          <dl class="dl-blog">
            ...
            <dd>
              <a target="_blank" href="https://gitee.com/fengziy/Fblog">
                <img class="icon" src="../assets/mayun.png" alt="码云" />
              </a>
            </dd>
